...
package com.ID3.id3v2Reader{
	public class Id3v2JacketSpr extends Id3v2Pic{
		...
		//コンストラクタ
		public function Id3v2JacketSpr(filePath:String, filePos:int, fileFrameSize:int , Width:uint , Height:uint){
		...
		private function imageScaleAjd(evt:Event):void{
			...
			*/
			...
			thumbImg = resize(thumbImg);		//画像のリサイズ
